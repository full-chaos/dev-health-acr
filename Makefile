.PHONY: fmt fmt-check test hosted-integration vet contract-write contract-test codegraph-contract build verify release-local release-verify container-contract container-pins container-test container-reproducible container-oci container-scan
...
verify: fmt-check vet test contract-test codegraph-contract build
