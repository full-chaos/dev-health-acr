...
func timeAxisCases() []timeAxisCase {
	return []timeAxisCase{
		...
		{"status", contextfabric.FactStatus, workItemSubject("repo-1", "WIDGET-101"), false},
		{"work", contextfabric.FactWork, workItemSubject("repo-1", "WIDGET-101"), false},
		{"blockers", contextfabric.FactBlockers, workItemSubject("repo-1", "WIDGET-101"), false},
		{"required_children", contextfabric.FactRequiredChildren, workItemSubject("repo-1", "WIDGET-101"), false},
		// Tier B -- derivable from immutable interval columns.
		{"actual_completion", contextfabric.FactActualCompletion, workItemSubject("repo-1", "WIDGET-101"), true},
		{"pull_requests", contextfabric.FactPullRequests, pullRequestSubject("repo-1", "1042"), true},
		{"reviews", contextfabric.FactReviews, reviewSubject("repo-1", "review-1"), true},
		{"continuous_integration", contextfabric.FactContinuousIntegration, ciRunSubject("repo-1", "run-1"), true},
		{"deployments", contextfabric.FactDeployments, deploymentSubject("repo-1", "deploy-1"), true},
