...
func TestTheMeasuredOddTurnShapeTerminates(t *testing.T) {
	...
	status, limitation := resolveTerminalStatus(request, &resolution, nil, false, decision, SubjectSubstitutionNotEvaluated)
...
func TestTheMeasuredEvenTurnShapeTerminates(t *testing.T) {
	...
	request := InvestigationRequest{Options: InvestigationOptions{AllowClarification: true}}
	status, limitation := resolveTerminalStatus(request, &resolution, nil, true, decision, SubjectSubstitutionNotEvaluated)
...
func TestAControlCandidateOfTheDeclaredKindStillClarifies(t *testing.T) {
	...
	request := InvestigationRequest{Options: InvestigationOptions{AllowClarification: true}}
	status, _ := resolveTerminalStatus(request, &resolution, nil, true, decision, SubjectSubstitutionNotEvaluated)
