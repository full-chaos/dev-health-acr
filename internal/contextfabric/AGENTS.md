...
The endpoint seam in `internal/api/context_fabric_routes.go` is intentionally not registered until Reset 0 publishes and validates the public contract artifacts.
