...
func TestFinalizingTwiceStatesOneUnavailableRankingRow(t *testing.T) {
	...
	for iteration := 0; iteration < refinalizations; iteration++ {
		again = engine.finalizeResult(context.Background(), storage.Principal{}, again, plan, frame, CanonicalFactBundle{}, &assemblyTelemetry{}, iteration, MembershipCardinality{})
