...
var SynthesisInput = Event{
	...
	Fields: []Field{
		...
		{Key: "label_canonicalization", Type: FieldString, Presence: PresenceRequired, ClosedVocabulary: []string{"unchanged", "collapsed", "residual", "unmeasured"}},
		{Key: "label_keys_collapsed", Type: FieldInt, Presence: PresenceRequired},
		{Key: "label_keys_residual", Type: FieldInt, Presence: PresenceRequired},
