...
func (c *Coordinator) Tick(ctx context.Context) {
	...
	c.logger.InfoContext(ctx, "context_fabric: projection tick freshness summary",
		...
		"failed_sources", contextfabric.SanitizeLogStrings(failedSources),
		...
		"failure_backoff_sources", contextfabric.SanitizeLogStrings(withheldSources),
		...
		"pair_failed", contextfabric.SanitizeLogStrings(pairFailedNames),
		"build_sources_failed", buildSourcesFailed,
		"build_failed_sources", contextfabric.SanitizeLogStrings(buildFailedSources),
