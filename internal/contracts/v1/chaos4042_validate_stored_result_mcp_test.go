...
func validMCPTestResult(schemaVersion string) contractsv1.ContextFabricInvestigationResult {
	...
	return contractsv1.ContextFabricInvestigationResult{
		...
		Warnings:            []string{},
		Completeness:        contractsv1.ContextFabricAnswerCompleteness{TerminalStatus: contractsv1.ContextFabricInvestigationComplete, State: contractsv1.ContextFabricAnswerCompletenessNotDerived},
	}
}
