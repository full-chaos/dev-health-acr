...
type queryConnection interface {
	Query(context.Context, string, map[string]string) (contextpacket.ClickHouseRowScanner, error)
...
func (c *Client) Query(ctx context.Context, statement string, bindings []contextpacket.ClickHouseBinding) (contextpacket.ClickHouseRowScanner, error) {
...
func (c nativeConnection) Query(ctx context.Context, statement string, parameters map[string]string) (contextpacket.ClickHouseRowScanner, error) {
