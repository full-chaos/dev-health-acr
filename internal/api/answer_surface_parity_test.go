...
func TestAnswerSurfaceParityBetweenRealAPIAndRealMCP(t *testing.T) {
	...
	if err := store.Save(context.Background(), storage.Principal{OrgID: callerOrgID}, result, contextfabric.SourceWatermarkSnapshot{}, nil, contextfabric.TimeAxisKeyFor(contextfabric.TimeContext{Axis: contextfabric.TemporalCurrent})); err != nil {
