...
func TestHistoricalAnswerReachesBothRealSurfacesLabelled(t *testing.T) {
	...
	if err := store.Save(context.Background(), storage.Principal{OrgID: callerOrgID}, result,
		...
		contextfabric.TimeAxisKeyFor(contextfabric.TimeContext{Axis: contextfabric.TemporalValidTime, AsOf: result.Temporal.Effective.AsOf}), contextfabric.ReuseRetrievalIdentity{}, contextfabric.ReusePromptVersions{}, contextfabric.ReuseVersionAuthorities{}, 0); err != nil {
