...
func TestObservedCatalogRowsReportsEveryDirectQueryTimeout(t *testing.T) {
	...
	_, _ = rows.ResolveEvidenceReference(context.Background(), plan.OrgID, contractsv1.ResolvedScope{RepoID: "repo_1", RepoSlug: plan.RepoSlug}, contextpacket.EvidenceReferenceLookup{QueryID: contextpacket.SourceQueryCatalogV1[0].ID})
