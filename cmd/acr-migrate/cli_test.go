...
func TestRun_reportsAppliedCountAndNoOpDistinctly(t *testing.T) {
	...
	// CHAOS-3786 added migration 0012 and CHAOS-3781 added 0013, so the
	// embedded set is now 13 files. A future migration must bump this
	...
	require.Equal(t, "applied 13 migrations\n", first.String())
