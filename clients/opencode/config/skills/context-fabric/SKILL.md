...
If the MCP server reports an unavailable or incompatible state, state it clearly. Do not substitute direct service calls, local-index queries, or write tools. Planning remains an explicit user-requested operation.
