---
name: plan-with-context-fabric
description: Explicitly retrieve ACR context and evidence before planning; this command never runs on its own.
---
...
Do not enable writeback and do not start this workflow by yourself.
